...
public class ShootingEffect extends Effect {
	...
	static Texture shotTexture = new Texture(
			Gdx.files.internal("data/shot.png"));
	...
	public void render(SpriteBatch batch, BitmapFont font,
		...
		int d = (int) Utils.getDistance(startVector.x, startVector.y,
		...
		float degrees = (float) Math.toDegrees(Math.atan2(endVector.y
				- startVector.y, endVector.x - startVector.x));
