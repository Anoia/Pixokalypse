...
public class PotentialFieldTestScreen implements Screen { // ,InputProcessor {
	...
	public PotentialFieldTestScreen(final PixokalypsePrototypes game) {
		 ...
		 * Gdx.graphics.getHeight())); Gdx.input.setInputProcessor(new
		 ...
		 * PlayerCharacter((int
		 * )Gdx.graphics.getWidth()/2,(int)Gdx.graphics.getHeight()/2, "name",
		 * "player"); manager.addPlayerCharacter(player3); player4 = new
