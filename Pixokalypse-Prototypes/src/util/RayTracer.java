...
public class RayTracer {
	...
	public boolean castRay(int startX, int startY, int endX, int endY,
			int range, boolean markInLightMap) {
		...
		if (dx > dy) {
			...
			ddx = incrementX;
			ddy = incrementY; /* dd. ist Diagonalschritt */
			es = dy;
			el = dx; /* Fehlerschritte schnell, langsam */
		} else {
			/* y ist schnelle Richtung */
			pdx = 0;
			pdy = incrementY; /* pd. ist Parallelschritt */
			ddx = incrementX;
			ddy = incrementY; /* dd. ist Diagonalschritt */
			es = dx;
